 ...
 * capability pills) are data-driven; illustrations sit at their outer boxes.
 */
...
// Portfolio folder grid — each Figma instance maps to its own export.
const FOLDERS: Tile[] = [
  { src: A.reveal.copy2a, l: 'left-[calc(58.33%_+_44px)]', t: 'top-[1139px]', w: 'w-[198px]', h: 'h-[155px]' },
  { src: A.reveal.copy2b, l: 'left-[calc(8.33%_-_10px)]', t: 'top-[1609px]', w: 'w-[216px]', h: 'h-[169px]' },
  { src: A.reveal.copy3a, l: 'left-[calc(8.33%_-_12px)]', t: 'top-[1132px]', w: 'w-[204px]', h: 'h-[161px]' },
  { src: A.reveal.copy3b, l: 'left-[calc(41.67%_+_29px)]', t: 'top-[1616px]', w: 'w-[224px]', h: 'h-[177px]' },
  { src: A.reveal.copy4a, l: 'left-[calc(25%_+_8px)]', t: 'top-[1132px]', w: 'w-[206px]', h: 'h-[161px]' },
  { src: A.reveal.copy4b, l: 'left-[calc(75%_+_42px)]', t: 'top-[1375px]', w: 'w-[226px]', h: 'h-[176px]' },
  { src: A.reveal.copy5a, l: 'left-[calc(41.67%_+_29px)]', t: 'top-[1138px]', w: 'w-[199px]', h: 'h-[156px]' },
  { src: A.reveal.copy5b, l: 'left-[calc(75%_+_78px)]', t: 'top-[1631px]', w: 'w-[199px]', h: 'h-[156px]' },
  { src: A.reveal.copy6, l: 'left-[calc(75%_+_58px)]', t: 'top-[1139px]', w: 'w-[193px]', h: 'h-[155px]' },
  { src: A.reveal.copy7, l: 'left-[calc(25%_+_8px)]', t: 'top-[1616px]', w: 'w-[212px]', h: 'h-[171px]' },
  { src: A.reveal.one1, l: 'left-[calc(8.33%_-_12px)]', t: 'top-[1356px]', w: 'w-[218px]', h: 'h-[171px]' },
  { src: A.reveal.one2, l: 'left-[calc(58.33%_+_58px)]', t: 'top-[1616px]', w: 'w-[218px]', h: 'h-[171px]' },
];
    ...
    <FixedCanvas height={9162}>
      ...
      <div className="absolute left-[calc(66.67%_+_3px)] top-[267px] h-[310px] w-[247px]">
        <div className="h-full w-full animate-float">
          <Asset src={A.reveal.hero} alt="reveal" />
        </div>
      </div>
      ...
      <div className="absolute left-[calc(66.67%_+_89px)] top-[3272px] h-[124px] w-[327px]">
        <Asset src={A.reveal.bridge3} alt="bridge" />
      </div>
      <div className="absolute left-[70px] top-[3301px] h-[112px] w-[344px]">
        <Asset src={A.reveal.bridge2} alt="bridge" />
      </div>
      ...
      <div className="absolute left-[calc(58.33%_+_76px)] top-[4838px] h-[330px] w-[328px]">
        <Asset src={A.reveal.conform} alt="conformity" />
      </div>
      ...
      <div className="absolute left-[calc(66.67%_+_49px)] top-[6204px] h-[567px] w-[227px]">
        <Asset src={A.reveal.plant01} alt="plant" />
      </div>
      ...
      <div className="absolute left-[calc(58.33%_+_72px)] top-[8220px] h-[186px] w-[395px]">
        <Asset src={A.reveal.layer14} alt="" placeholder="blank" />
      </div>
      <div className="absolute left-[calc(66.67%_+_15px)] top-[8349px] h-[185px] w-[237px]">
        <Asset src={A.reveal.one4} alt="portfolio" />
      </div>
