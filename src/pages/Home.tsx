  ...
  return (
    <FixedCanvas height={12090}>
      ...
      <div className="absolute left-[calc(41.67%_+_22px)] top-[294px] h-[164px] w-[40px]">
        <Asset src={A.home.layer14} alt="sprout" placeholder="blank" />
      </div>
      <div className="absolute left-[calc(50%_+_57px)] top-[327px] h-[98px] w-[24px]">
        <Asset src={A.home.layer14b} alt="sprout" placeholder="blank" />
      </div>

      {/* hero soil line */}
      <div className="absolute left-0 top-[651px] h-[84px] w-[1440px]">
        <Asset src={A.home.lines} alt="ground line" placeholder="line" />
      </div>
      ...
      <div className="absolute left-[calc(33.33%_+_35px)] top-[2240px] h-[684.779px] w-[876.656px]">
        <div className="h-full w-full animate-float">
          <Asset src={A.home.waterCan} alt="water can" />
        </div>
      </div>
      ...
      <div className="absolute left-0 top-[2797px] h-[1102px] w-[1440px]">
        <Asset src={A.home.group2} alt="the nursery soil" />
      </div>
      ...
      <div className="absolute left-[51px] top-[4138px] h-[717px] w-[1362px]">
        <Asset src={A.home.withered} alt="withered plants" />
      </div>
      ...
      <div className="absolute left-[calc(16.67%_+_49px)] top-[5478px] h-[885.536px] w-[453.864px]">
        <Asset src={A.home.radikle} alt="radicle" />
      </div>
      ...
      <div className="absolute left-[calc(16.67%_-_7px)] top-[6822px] h-[930px] w-[887px]">
        <Asset src={A.home.plant} alt="nursery plant" />
      </div>
      ...
      <div className="absolute left-0 top-[8466px] h-[847px] w-[1440px]">
        <Asset src={A.home.roots} alt="roots" />
      </div>
      ...
      <div className="absolute left-[calc(41.67%_+_45px)] top-[11109px] h-[203px] w-[161px]">
        <Asset src={A.home.lasst} alt="seed" />
      </div>
