 ...
 * Illustrations are placed at their outer boxes and filled.
 */
...
export default function WhatWeDo() {
  return (
    <FixedCanvas height={9489}>
      ...
      <div className="absolute left-[calc(58.33%_+_85.36px)] top-[274.73px] h-[248.114px] w-[182.916px]">
        <Asset src={A.whatWeDo.seedCluster} alt="seed" />
      </div>
      ...
      <div className="absolute left-[calc(16.67%_+_3px)] top-[987px] h-[401px] w-[477px]">
        <Asset src={A.whatWeDo.roots2} alt="roots" />
      </div>
      <div className="absolute left-[calc(50%_+_68px)] top-[995px] h-[311.493px] w-[428.6px]">
        <Asset src={A.whatWeDo.waterCan2} alt="water can" />
      </div>
      <div className="absolute left-[calc(41.67%_+_10px)] top-[1557px] h-[260.289px] w-[299.727px]">
        <Asset src={A.whatWeDo.radikle2} alt="radicle" />
      </div>
      <div className="absolute left-[calc(25%_+_89px)] top-[1535px] h-[22px] w-[545px]">
        <Asset src={A.whatWeDo.roots3} alt="" placeholder="blank" />
      </div>
      ...
      <div className="absolute left-[calc(41.67%_-_0.32px)] top-[2701.62px] h-[432.435px] w-[542.627px]">
        <Asset src={A.whatWeDo.layer20} alt="illustration" />
      </div>
      <div className="absolute left-[calc(41.67%_+_34px)] top-[3902px] h-[295px] w-[171px]">
        <Asset src={A.whatWeDo.layer23} alt="" placeholder="blank" />
      </div>
      <div className="absolute left-[calc(8.33%_+_50px)] top-[3292px] h-[395.038px] w-[387.504px]">
        <Asset src={A.whatWeDo.layer22c} alt="" placeholder="blank" />
      </div>
      <div className="absolute left-[calc(58.33%_+_56px)] top-[3285px] h-[395.038px] w-[387.504px]">
        <Asset src={A.whatWeDo.layer22b} alt="" placeholder="blank" />
      </div>
      <div className="absolute left-[calc(16.67%_+_30px)] top-[2917px] h-[237px] w-[48px]">
        <Asset src={A.whatWeDo.layer21a} alt="" placeholder="blank" />
      </div>
      <div className="absolute left-[calc(41.67%_+_82px)] top-[4423px] h-[161px] w-[48px]">
        <Asset src={A.whatWeDo.layer21b} alt="" placeholder="blank" />
      </div>
      ...
      <div className="absolute left-[calc(41.67%_+_94px)] top-[4891px] h-[373px] w-[543px]">
        <Asset src={A.whatWeDo.layer27} alt="illustration" />
      </div>
      <div className="absolute left-[calc(16.67%_+_78px)] top-[4892px] h-[149px] w-[843px]">
        <Asset src={A.whatWeDo.layer28} alt="illustration" />
      </div>
      ...
      <div className="absolute left-[calc(58.33%_+_4px)] top-[7276px] h-[148px] w-[314px]">
        <Asset src={A.whatWeDo.ground} alt="ground" />
      </div>
      <div className="absolute left-[calc(25%_+_72px)] top-[7407px] h-[394.815px] w-[396.299px]">
        <Asset src={A.whatWeDo.layer31} alt="illustration" />
      </div>
      <div className="absolute left-[calc(41.67%_+_100px)] top-[7860px] h-[176px] w-[188px]">
        <Asset src={A.whatWeDo.aspirational1} alt="illustration" />
      </div>
      <div className="absolute left-[calc(50%_+_24px)] top-[7747px] h-[146.71px] w-[149.811px]">
        <Asset src={A.whatWeDo.aspirational2} alt="" placeholder="blank" />
      </div>
      <div className="absolute left-[calc(50%_+_96.5px)] top-[7971.88px] h-[110.428px] w-[114.377px]">
        <Asset src={A.whatWeDo.aspirational3} alt="" placeholder="blank" />
      </div>
